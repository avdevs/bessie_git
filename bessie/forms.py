...
# Scoring patterns for reusable choice patterns
#
# MAINTAINER GUIDE:
# To add a new question with duplicate choice values:
# 1. Add the question identifier to form choices using pattern "question_0", "question_1", etc.
# 2. If it follows an existing pattern, add it to QUESTION_PATTERNS mapping to that pattern name
# 3. If it's a new pattern, either:
#    - Add the scoring array directly: "q123": [6, 5, 4, 0, 2, 1, 0]
#    - Create a new pattern in SCORING_PATTERNS and reference it: "q123": "NEW_PATTERN_NAME"
#
# Examples:
# - q101 uses SIX_ZERO_ZERO pattern: [6, 5, 4, 0, 2, 1, 0]
# - q143 uses ZERO_ONE_TWO_ZERO_FOUR_FIVE pattern: [0, 1, 2, 0, 4, 5]
# - q21 has custom scoring: [1, 0, 0, 0, 2]
#
SCORING_PATTERNS = {
	"ZERO_ZERO_SIX": [0, 1, 2, 0, 4, 5, 6],
	"ZERO_ZERO_SIX_ZERO": [0, 1, 2, 0, 4, 5, 6, 0],
	"SIX_ZERO_ZERO": [6, 5, 4, 0, 2, 1, 0],
	"SIX_ZERO_ZERO_ZERO": [6, 5, 4, 0, 2, 1, 0, 0],
	"ALL_ZEROS_3": [0, 0, 0],
	"ALL_ZEROS_6": [0, 0, 0, 0, 0, 0],
	"EMOTION_POSITIVE": [2, 1, 0, 0, 2],
	"EMOTION_NEGATIVE": [2, 1, 0, 1, 2],
	"ZERO_ONE_TWO_ZERO_FOUR_FIVE": [0, 1, 2, 0, 4, 5],
	"THREE_TWO_ONE_FOUR_ZEROS": [3, 2, 1, 0, 0, 0, 0],
	"YES_NO_ZEROS": [0, 0],
}

# Question to pattern mapping
QUESTION_PATTERNS = {
	# Existing pattern-based questions
	"zero_zero_six": "ZERO_ZERO_SIX",
	"zero_zero_six_zero": "ZERO_ZERO_SIX_ZERO",
	"six_zero_zero": "SIX_ZERO_ZERO",
	"six_zero_zero_zero": "SIX_ZERO_ZERO_ZERO",
	# Individual question patterns
	"q9": [2, 0, 0, 0, 0, 0],
	"q10": [6, 5, 4, 0, 2, 1, 0, 0],
	"q13": "ALL_ZEROS_3",
	"q21": [1, 0, 0, 0, 2],
	...
	"q123": "YES_NO_ZEROS",
	"q133": [0, 1, 2, 3, 4, 0],
	# ZERO_ONE_TWO_ZERO_FOUR_FIVE pattern questions
	"q143": "ZERO_ONE_TWO_ZERO_FOUR_FIVE",
	"q144": "ZERO_ONE_TWO_ZERO_FOUR_FIVE",
	"q145": "ZERO_ONE_TWO_ZERO_FOUR_FIVE",
	# All zeros questions
	"q160": "ALL_ZEROS_6",
	"q161": "ALL_ZEROS_3",
	# Emotion questions
	"q204": "EMOTION_POSITIVE",
	"q205": "EMOTION_POSITIVE",
	"q206": "EMOTION_POSITIVE",
	"q207": "EMOTION_POSITIVE",
	"q208": "EMOTION_POSITIVE",
	"q209": "EMOTION_NEGATIVE",
	"q210": "EMOTION_NEGATIVE",
	"q211": "EMOTION_NEGATIVE",
	"q212": "EMOTION_NEGATIVE",
	"q213": "EMOTION_NEGATIVE",
	"q214": "EMOTION_NEGATIVE",
	# Impact questions (new pattern)
	"q215": "THREE_TWO_ONE_FOUR_ZEROS",
	"q216": "THREE_TWO_ONE_FOUR_ZEROS",
	"q217": "THREE_TWO_ONE_FOUR_ZEROS",
	"q218": "THREE_TWO_ONE_FOUR_ZEROS",
	"q219": "THREE_TWO_ONE_FOUR_ZEROS",
}


def get_choice_score(choice_value):
	"""Convert choice identifier back to scoring value."""
	# Handle direct numeric values (backward compatibility)
	if isinstance(choice_value, (int, float)):
		return choice_value

	# Handle string identifiers
	if isinstance(choice_value, str):
		# Check if it's a pattern-based identifier (e.g., "zero_zero_six_0" or "q101_0")
		if "_" in choice_value:
			parts = choice_value.split("_")
			if len(parts) >= 2:
				# Extract the index (last part should be numeric)
				try:
					index = int(parts[-1])
					# Get the pattern key (everything except the last part)
					pattern_key = "_".join(parts[:-1])

					# Look up the pattern
					if pattern_key in QUESTION_PATTERNS:
						pattern = QUESTION_PATTERNS[pattern_key]
						# If pattern is a string reference, look it up in SCORING_PATTERNS
						if isinstance(pattern, str) and pattern in SCORING_PATTERNS:
							pattern = SCORING_PATTERNS[pattern]
						# If pattern is a list, get the score at index
						if isinstance(pattern, list) and 0 <= index < len(pattern):
							return pattern[index]

				except (ValueError, IndexError):
					pass

		# Fallback: try to convert string to int
		try:
...
ZERO_ZERO_SIX = [
	("zero_zero_six_0", "Strongly Agree"),
	("zero_zero_six_1", "Agree"),
	("zero_zero_six_2", "Somewhat Agree"),
	("zero_zero_six_3", "Neither Agree Nor Disagree"),
	("zero_zero_six_4", "Somewhat Disagree"),
	("zero_zero_six_5", "Disagree"),
	("zero_zero_six_6", "Strongly Disagree"),
]

ZERO_ZERO_SIX_ZERO = [
	("zero_zero_six_zero_0", "Strongly Agree"),
	("zero_zero_six_zero_1", "Agree"),
	("zero_zero_six_zero_2", "Somewhat Agree"),
	("zero_zero_six_zero_3", "Neither Agree Nor Disagree"),
	("zero_zero_six_zero_4", "Somewhat Disagree"),
	("zero_zero_six_zero_5", "Disagree"),
	("zero_zero_six_zero_6", "Strongly Disagree"),
	("zero_zero_six_zero_7", "Not Applicable"),
]

SIX_ZERO_ZERO = [
	("six_zero_zero_0", "Strongly Agree"),
	("six_zero_zero_1", "Agree"),
	("six_zero_zero_2", "Somewhat Agree"),
	("six_zero_zero_3", "Neither Agree Nor Disagree"),
	("six_zero_zero_4", "Somewhat Disagree"),
	("six_zero_zero_5", "Disagree"),
	("six_zero_zero_6", "Strongly Disagree"),
]

SIX_ZERO_ZERO_ZERO = [
	("six_zero_zero_zero_0", "Strongly Agree"),
	("six_zero_zero_zero_1", "Agree"),
	("six_zero_zero_zero_2", "Somewhat Agree"),
	("six_zero_zero_zero_3", "Neither Agree Nor Disagree"),
	("six_zero_zero_zero_4", "Somewhat Disagree"),
	("six_zero_zero_zero_5", "Disagree"),
	("six_zero_zero_zero_6", "Strongly Disagree"),
	("six_zero_zero_zero_7", "Not Applicable"),
]
...
class Form3(forms.Form):
	q10 = forms.ChoiceField(
		...
		choices=[
			("q10_0", "Very Difficult"),
			("q10_1", "Difficult"),
			("q10_2", "Somewhat Difficult"),
			("q10_3", "Neither Difficult Nor Easy"),
			("q10_4", "Somewhat Easy"),
			("q10_5", "Easy"),
			("q10_6", "Very Easy"),
			("q10_7", "Not Applicable"),
		],
		widget=forms.RadioSelect,
		required=False,
	)
	...
	q13 = forms.ChoiceField(
		...
		choices=[
			("q13_0", "The Workplace"),
			("q13_1", "Home"),
			("q13_2", "Combination of both home and the workplace"),
		],
		widget=forms.RadioSelect,
		required=False,
	)
...
class Form4(forms.Form):
	...
	q21 = forms.ChoiceField(
		...
		choices=[
			("q21_0", "This Is My First Job"),
			("q21_1", "2 - 5 Jobs"),
			("q21_2", "6 -10 Jobs"),
			("q21_3", "11 - 20 Jobs"),
			("q21_4", "20 Or More Jobs"),
		],
		widget=forms.RadioSelect,
		required=False,
	)
...
class Form14(forms.Form):
	q101 = forms.ChoiceField(
		...
		choices=[
			("q101_0", "Very Poor"),
			("q101_1", "Poor"),
			("q101_2", "Somewhat Poor"),
			("q101_3", "Neither Poor Nor Good"),
			("q101_4", "Somewhat Good"),
			("q101_5", "Good"),
			("q101_6", "Very Good"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
	...
	q102 = forms.ChoiceField(
		...
		choices=[
			("q102_0", "Very Poor"),
			("q102_1", "Poor"),
			("q102_2", "Somewhat Poor"),
			("q102_3", "Neither Poor Nor Good"),
			("q102_4", "Somewhat Good"),
			("q102_5", "Good"),
			("q102_6", "Very Good"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
	...
	q103 = forms.ChoiceField(
		...
		choices=[
			("q103_0", "Strongly Declined"),
			("q103_1", "Declined"),
			("q103_2", "Somewhat Declined"),
			("q103_3", "Neither Declined Nor Improved"),
			("q103_4", "Somewhat Improved"),
			("q103_5", "Improved"),
			("q103_6", "Strongly Improved"),
		],
		widget=forms.RadioSelect,
		required=False,
	)
...
class Form16(forms.Form):
	q114 = forms.ChoiceField(
		...
		choices=[
			("q114_0", "Very Poor"),
			("q114_1", "Poor"),
			("q114_2", "Somewhat Poor"),
			("q114_3", "Neither Poor Nor Good"),
			("q114_4", "Somewhat Good"),
			("q114_5", "Good"),
			("q114_6", "Very Good"),
		],
		widget=forms.RadioSelect,
...
class Form17(forms.Form):
	...
	q130 = forms.ChoiceField(
		...
		choices=[
			("q130_0", "Very Negatively"),
			("q130_1", "Negatively"),
			("q130_2", "Somewhat Negatively"),
			("q130_3", "Neither Negatively or Positively"),
			("q130_4", "Somewhat Positively"),
			("q130_5", "Positively"),
			("q130_6", "Very positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q131 = forms.ChoiceField(
		...
		choices=[
			("q131_0", "Very Negatively"),
			("q131_1", "Negatively"),
			("q131_2", "Somewhat Negatively"),
			("q131_3", "Neither Negatively or Positively"),
			("q131_4", "Somewhat Positively"),
			("q131_5", "Positively"),
			("q131_6", "Very positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q132 = forms.ChoiceField(
		...
		choices=[
			("q132_0", "Very Negatively"),
			("q132_1", "Negatively"),
			("q132_2", "Somewhat Negatively"),
			("q132_3", "Neither Negatively or Positively"),
			("q132_4", "Somewhat Positively"),
			("q132_5", "Positively"),
			("q132_6", "Very positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q133 = forms.ChoiceField(
		...
		choices=[
			("q133_0", "None"),
			("q133_1", "A Small Extent"),
			("q133_2", "A Moderate Extent"),
			("q133_3", "A Significant Extent"),
			("q133_4", "Completely"),
			("q133_5", "Not Applicable"),
		],
		widget=forms.RadioSelect,
		required=False,
	)
...
class Form18(forms.Form):
	...
	q138 = forms.ChoiceField(
		...
		Positively</div><div class="frm_likert__column">Very Positively</div></div></div>',
		choices=[
			("q138_0", "Very Negatively"),
			("q138_1", "Negatively"),
			("q138_2", "Somewhat Negatively"),
			("q138_3", "Neither Negatively or Positively"),
			("q138_4", "Somewhat Positively"),
			("q138_5", "Positively"),
			("q138_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q139 = forms.ChoiceField(
		...
		choices=[
			("q139_0", "Very Negatively"),
			("q139_1", "Negatively"),
			("q139_2", "Somewhat Negatively"),
			("q139_3", "Neither Negatively or Positively"),
			("q139_4", "Somewhat Positively"),
			("q139_5", "Positively"),
			("q139_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q140 = forms.ChoiceField(
		...
		choices=[
			("q140_0", "Very Negatively"),
			("q140_1", "Negatively"),
			("q140_2", "Somewhat Negatively"),
			("q140_3", "Neither Negatively or Positively"),
			("q140_4", "Somewhat Positively"),
			("q140_5", "Positively"),
			("q140_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
...
class Form19(forms.Form):
	q143 = forms.ChoiceField(
        ...
        Disagree</div><div class="frm_likert__column">Strongly Disagree</div></div></div>',
		choices=[
			("q143_0", "Strongly Agree"),
			("q143_1", "Agree"),
			("q143_2", "Somewhat Agree"),
			("q143_3", "Neither Agree Nor Disagree"),
			("q143_4", "Disagree"),
			("q143_5", "Strongly Disagree"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q144 = forms.ChoiceField(
		...
		choices=[
			("q144_0", "Strongly Agree"),
			("q144_1", "Agree"),
			("q144_2", "Somewhat Agree"),
			("q144_3", "Neither Agree Nor Disagree"),
			("q144_4", "Disagree"),
			("q144_5", "Strongly Disagree"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q145 = forms.ChoiceField(
		...
		choices=[
			("q145_0", "Strongly Agree"),
			("q145_1", "Agree"),
			("q145_2", "Somewhat Agree"),
			("q145_3", "Neither Agree Nor Disagree"),
			("q145_4", "Disagree"),
			("q145_5", "Strongly Disagree"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
...
class Form21(forms.Form):
	...
	q179 = forms.ChoiceField(
		...
		Positively</div><div class="frm_likert__column">Very Positively</div></div></div>',
		choices=[
			("q179_0", "Very Negatively"),
			("q179_1", "Negatively"),
			("q179_2", "Somewhat Negatively"),
			("q179_3", "Neither Negatively or Positively"),
			("q179_4", "Somewhat Positively"),
			("q179_5", "Positively"),
			("q179_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q180 = forms.ChoiceField(
		...
		choices=[
			("q180_0", "Very Negatively"),
			("q180_1", "Negatively"),
			("q180_2", "Somewhat Negatively"),
			("q180_3", "Neither Negatively or Positively"),
			("q180_4", "Somewhat Positively"),
			("q180_5", "Positively"),
			("q180_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q181 = forms.ChoiceField(
		...
		choices=[
			("q181_0", "Very Negatively"),
			("q181_1", "Negatively"),
			("q181_2", "Somewhat Negatively"),
			("q181_3", "Neither Negatively or Positively"),
			("q181_4", "Somewhat Positively"),
			("q181_5", "Positively"),
			("q181_6", "Very Positively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
...
class Form26(forms.Form):
	q215 = forms.ChoiceField(
		...
		help_text='<h3>Personal (Continued)</h3>\
			...
			Positively</div><div class="frm_likert__column">Very Positively</div></div></div>',
		choices=[
			("q215_0", "Very Negatively"),
			("q215_1", "Negatively"),
			("q215_2", "Somewhat Negatively"),
			("q215_3", "Neither Negatively or Postively"),
			("q215_4", "Somewhat Postively"),
			("q215_5", "Postively"),
			("q215_6", "Very Postively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q216 = forms.ChoiceField(
		...
		choices=[
			("q216_0", "Very Negatively"),
			("q216_1", "Negatively"),
			("q216_2", "Somewhat Negatively"),
			("q216_3", "Neither Negatively or Postively"),
			("q216_4", "Somewhat Postively"),
			("q216_5", "Postively"),
			("q216_6", "Very Postively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q217 = forms.ChoiceField(
		...
		choices=[
			("q217_0", "Very Negatively"),
			("q217_1", "Negatively"),
			("q217_2", "Somewhat Negatively"),
			("q217_3", "Neither Negatively or Postively"),
			("q217_4", "Somewhat Postively"),
			("q217_5", "Postively"),
			("q217_6", "Very Postively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q218 = forms.ChoiceField(
		...
		help_text='<h3>Personal (Continued)</h3>\
			...
			Positively</div><div class="frm_likert__column">Very Positively</div></div></div>',
		choices=[
			("q218_0", "Very Negatively"),
			("q218_1", "Negatively"),
			("q218_2", "Somewhat Negatively"),
			("q218_3", "Neither Negatively or Postively"),
			("q218_4", "Somewhat Postively"),
			("q218_5", "Postively"),
			("q218_6", "Very Postively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	q219 = forms.ChoiceField(
		...
		choices=[
			("q219_0", "Very Negatively"),
			("q219_1", "Negatively"),
			("q219_2", "Somewhat Negatively"),
			("q219_3", "Neither Negatively or Postively"),
			("q219_4", "Somewhat Postively"),
			("q219_5", "Postively"),
			("q219_6", "Very Postively"),
		],
		widget=ExternalLabelRadioSelect(attrs={"class": "inline-radios"}),
		required=False,
	)
	...
	def clean(self):
		...
		if survey_start and survey_completion and strategy_meeting:
			...
			if strategy_meeting < survey_start:
				raise ValidationError("Strategy meeting date must be after survey start date.")
