...
class BessieResponseAdmin(admin.ModelAdmin):
    list_display = ["id", "get_employee_first_name", "get_employee_last_name", "employee__company__name"]
...
class BessieResultAdmin(admin.ModelAdmin):
    list_display = ["id", "get_employee_first_name", "get_employee_last_name", "company__name"]
...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ["name", "slots", "survey_start_date", "survey_completion_date", "strategy_meeting_date"]
    search_fields = ["name"]

@admin.register(Employee)
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ["user__first_name", "user__last_name", "company__name", "team"]
    list_filter = ["company__name"]
