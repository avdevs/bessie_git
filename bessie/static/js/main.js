...
q105radios.forEach((radio) => {
	radio.addEventListener("change", (event) => {
		...
		if (selectedValue === "2") {
			...
			document.getElementById("q111Heading").style.display = "flex";
...
q115radios.forEach((radio) => {
	radio.addEventListener("change", (event) => {
		...
		if (selectedValue === "2") {
			...
			document.getElementById("q120Heading").style.display = "flex";
...
q134radios.forEach((radio) => {
	radio.addEventListener("change", (event) => {
		...
		if (selectedValue === "2") {
			...
			document.getElementById("q135Heading").style.display = "flex";
			...
			document.getElementById("q138Heading").style.display = "flex";
...
q163radios.forEach((radio) => {
	radio.addEventListener("change", (event) => {
		...
		if (selectedValue === "0") {
			...
			document.getElementById("q164Heading").style.display = "flex";
...
q177radios.forEach((radio) => {
	radio.addEventListener("change", (event) => {
		...
		if (selectedValue === "2") {
			...
			document.getElementById("q179Heading").style.display = "flex";
