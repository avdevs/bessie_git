...
from .views import index, view_results, BessieQuizWizard, user_results, user_list, view_company_results, CompanyFormView, companyDetail, inviteAdmin
from .forms import *


urlpatterns = [
    #path('dashboard/', dashboard, name='dashboard'),
    path('take-quiz/', BessieQuizWizard.as_view([Form1, Form2, Form3, Form4, Form5, Form6, Form7, Form8, Form9, Form10, Form11, Form12, Form13, Form14, Form15, Form16, Form17, Form18, Form19, Form20, Form21, Form22, Form23, Form24, Form25, Form26, Form27]), name='take_quiz'),
